...
int http_open_request_socket(struct http_request *request)
{
    ...
    LOG("http_open_request_socket: getaddrinfo succeeded");
    ...
    LOG("http_open_request_socket: socket succeeded");
    ...
    LOG("http_open_request_socket: connect succeeded");
