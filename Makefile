...
SOURCES := fonts.c journey.c journey-task.c config.c oled_framebuffer.c framebuffer.c display.c display-message.c \
...
$(TSTBINDIR)test_oled_framebuffer: $(TSTOBJDIR)oled_framebuffer.o
